  ...
  return (
    <header className={styles.header}>
            ...
            {/* logo */}
              ...
              <nav className={styles.nav}>
                <ul >
                    ...
                    <Link className={styles.links} href='/dishes'><li >Dishes</li></Link>
        ...
        <nav className={`${styles.mobNav} ${OpenMenu ? styles.showMwnu : ''} `}>
                <ul className='   flex-col py-10   bg-purple-700 gap-x-10 text-white text-lg font-bold  '>
                    ...
                    <Link className={styles.links} href='/dishes'><li className='mt-6 hover:bg-white hover:text-purple-700 '>Dishes</li></Link>
